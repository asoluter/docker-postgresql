# asoluter/postgresql:15.1-20230122
...
```bash
docker pull asoluter/postgresql:15.1-20230122
```
...
```bash
docker run --name postgresql -itd --restart always \
  asoluter/postgresql:15.1-20230122 -c log_connections=on
```
...
```bash
docker run --name postgresql -itd --restart always \
  asoluter/postgresql:15.1-20230122 -c logging_collector=on
```

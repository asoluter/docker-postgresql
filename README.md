# asoluter/postgresql:15.1-20230125
...
```bash
docker pull asoluter/postgresql:15.1-20230125
```
...
```bash
docker run --name postgresql -itd --restart always \
  asoluter/postgresql:15.1-20230125 -c log_connections=on
```
...
```bash
docker run --name postgresql -itd --restart always \
  asoluter/postgresql:15.1-20230125 -c logging_collector=on
```

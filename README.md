# asoluter/postgresql:15-20221110
...
```bash
docker pull asoluter/postgresql:15-20221110
```
...
```bash
docker run --name postgresql -itd --restart always \
  asoluter/postgresql:15-20221110 -c log_connections=on
```
...
```bash
docker run --name postgresql -itd --restart always \
  asoluter/postgresql:15-20221110 -c logging_collector=on
```

# asoluter/postgresql:15.1-20230123
...
```bash
docker pull asoluter/postgresql:15.1-20230123
```
...
```bash
docker run --name postgresql -itd --restart always \
  asoluter/postgresql:15.1-20230123 -c log_connections=on
```
...
```bash
docker run --name postgresql -itd --restart always \
  asoluter/postgresql:15.1-20230123 -c logging_collector=on
```

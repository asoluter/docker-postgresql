# asoluter/postgresql:13-20211010
...
```bash
docker pull asoluter/postgresql:13-20211010
```
...
```bash
docker run --name postgresql -itd --restart always \
  asoluter/postgresql:13-20211010 -c log_connections=on
```
...
```bash
docker run --name postgresql -itd --restart always \
  asoluter/postgresql:13-20211010 -c logging_collector=on
```
